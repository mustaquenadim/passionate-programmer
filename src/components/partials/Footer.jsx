        ...
        <Row>
          <Col md={6}>
            ...
            <p className="pe-5 mb-3">
              Reduce Fluffy একটি প্রোগ্রামিং বিষয়ক প্রশ্ন-উত্তর ওয়েবসাইট।
              প্রোগ্রামিং জগতে যারা নতুন প্রবেশ করছে এবং যারা এই জগতে ইতোমধ্যেই
              ঘুরাঘুরি করছে তারা যেন শিখতে গিয়ে কিংবা কাজ করতে গিয়ে সমস্যায় পড়ে
              হতাশ হয়ে প্রোগ্রামিং ছেড়ে না দেয়। বরং কোন এক জায়গায় জিজ্ঞাসা করে
              সমাধান পেতে পারে সেজন্যই আমরা এই মঞ্চটি তৈরি করেছি।
            </p>
